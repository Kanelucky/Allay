...
public class FakeHopperContainerImpl extends FakeContainerImpl {
    ...
    protected void sendFakeBlocks(Player player) {
        ...
        var nbt = NbtMap
                .builder().putString("id", BlockEntityId.HOPPER).putInt("x", pos.x()).putInt("y", pos.y()).putInt("z", pos.z());
        ...
        allayPlayer.sendPacket(allayPlayer.getProtocol().getEncoder().encodeBlockEntityData(pos, nbt.build()));
