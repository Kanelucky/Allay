...
public class EntityFoxImpl extends EntityImpl implements EntityFox {
    ...
    @Delegate
    private EntitySleepableComponent sleepComponent;

    public EntityFoxImpl(EntityInitInfo initInfo, List<ComponentProvider<? extends Component>> componentProviders) {
