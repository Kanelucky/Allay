...
public interface BlockPropertyTypes {
    ...
    IntPropertyType DIRECTION_16 = IntPropertyType.of("direction", 0, 15, 0);

    IntPropertyType DIRECTION_4 = IntPropertyType.of("direction", 0, 3, 0);
    ...
    IntPropertyType GROWTH_2 = IntPropertyType.of("growth", 0, 1, 0);

    IntPropertyType GROWTH_8 = IntPropertyType.of("growth", 0, 7, 0);
    ...
    BooleanPropertyType MINECRAFT_CONNECTION_EAST = BooleanPropertyType.of("minecraft:connection_east", false);

    BooleanPropertyType MINECRAFT_CONNECTION_NORTH = BooleanPropertyType.of("minecraft:connection_north", false);

    BooleanPropertyType MINECRAFT_CONNECTION_SOUTH = BooleanPropertyType.of("minecraft:connection_south", false);

    BooleanPropertyType MINECRAFT_CONNECTION_WEST = BooleanPropertyType.of("minecraft:connection_west", false);

    EnumPropertyType<MinecraftCorner> MINECRAFT_CORNER = EnumPropertyType.of("minecraft:corner", MinecraftCorner.class, MinecraftCorner.values()[0]);
